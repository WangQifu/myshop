	...
	<table id="tb" class="easyui-datagrid" title="商品列表" style="width:100%;height:70%"
			...
			url:'index.php?control=m_index&action=getprod',
			method:'get',rownumbers:'true'">
		<thead>
			<tr>
				<th data-options="field:'prod_name',width:80">商品名称</th>
				<th data-options="field:'prod_store_name',width:200">店铺</th>
				<th data-options="field:'prod_city',width:200">主要服务城市</th>
	 ...
	 {
	 	return "<a href='/?id="+val+"' color='#666'>编辑</a>"
	 }
	 $(function(){
	 	//以下是对分页控件的处理
