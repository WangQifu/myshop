		...
		<div class="col-md-7 column">
		      <h2><?php $qname = $de_json[0]; echo $qname->name;?>开奖</h2>
                ...
                <div class="lottery_wrap2">
                                                                           差值    
                    <div id="checkBall">
                      <button type="button" class="btn" data-toggle="popover" data-placement="bottom" title="合值、平均值" data-content="<?php $str=computeZu(array_sum($equalNum), null, 3, 0); echo $str;?>">
                                                                            差值计算
                    </button>
                    </div>
                ...
                <div class="lottery_wrap" id="lotteryWrap"> 
                    开奖
                    <div id="checkBall">
                    <button type="button" class="btn" data-toggle="popover" data-placement="bottom" title="合值、平均值" data-content="<?php $str=computeZu(array_sum($ballNum), null, 3, 0); echo $str;?>">
