		...
		<div class="col-md-7 column">
		      <h2><?php $qname = $de_json[0]; echo $qname->name;?>开奖</h2>
                ...
                <div class="lottery_wrap2">
                                                                           差值    
                    <div id="checkBall">
                      <button type="button" class="btn" data-toggle="popover" data-placement="bottom" title="合值、平均值" data-content="<?php $str=computeZu(array_sum($equalNum), null, 5, 0); echo $str;?>">
                                                                            差值计算
                    </button>
                    </div>
                ...
                <div class="lottery_wrap" id="lotteryWrap"> 
                    开奖
                    <div id="checkBall">
                    <button type="button" class="btn" data-toggle="popover" data-placement="bottom" title="合值、平均值" data-content="<?php $str=computeZu(array_sum($ballNum), null, 5, 0); echo $str;?>">
		...
		<h2>统计</h2>
            ...
            <?php if (!the_user()){?>
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                      <?php  $nball=explode("+",$numball);
                            if ($cpName=="pl5")
                            {
                      ?>
                      <div class="lottery_wrap3">
                      <ul class="fs_red_area"> 
                      <li><span class="predNum">万</span><div class="text-center">次数</div></li>
                      <?php                                       
                		  for ($i = 0; $i <= $nball[0]; $i++) {
                		      $number=$i;
                      ...
                      <ul class="fs_red_area"> 
                      <li><span class="predNum">千</span><div class="text-center">次数</div></li>
                      <?php
                      ...
                      <ul class="fs_red_area">
                      <li><span class="predNum">百</span><div class="text-center">次数</div></li> 
                      <?php 
                      ...
                      <div class="lottery_wrap3">
                      <ul class="fs_red_area"> 
                      <li><span class="predNum">十</span><div class="text-center">次数</div></li>
                      <?php 
                      ...
                      <div class="lottery_wrap3">
                      <ul class="fs_red_area"> 
                      <li><span class="predNum">个</span><div class="text-center">次数</div></li>
                      <?php 
