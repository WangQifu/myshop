	...
	<div class="row clearfix">
		<div class="col-md-7 column">
		      <h2><?php $qname = $de_json[0]; echo $qname->name;?>开奖</h2>
                ...
                $cnum = 1;
                $redCounrAry = array();
                $cred1 = array(); $cred2 = array(); $cred3 = array(); $cred4 = array(); $cred5 = array(); $cred6 = array(); $cred7 = array();
                $cblue1 = array();
                ...
                <div class="lottery_wrap2">
                                                                           差值    
                    <div id="checkBall">
                      <button type="button" class="btn" data-toggle="popover" data-placement="bottom" title="合值、平均值" data-content="<?php $str=computeZu(array_sum($equalNum), $equalNBlue, 7, 8); echo $str;?>">
                                                                            差值计算
                    </button>
                    </div>
                ...
                <div class="lottery_wrap" id="lotteryWrap"> 
                    开奖
                    <div id="checkBall">
                    <button type="button" class="btn" data-toggle="popover" data-placement="bottom" title="合值、平均值" data-content="<?php $str=computeZu(array_sum($redAry), $ballNum[1], 7, 8); echo $str;?>">
                    <?php echo $ary_json->expect;?>期
                    </button>
                    </div>
